            ...
            <div className='relative  h-[100px] hidden sm:hidden md:block md:w-[70%] lg:w-[70%] lg:block'>
                ...
                <div className='absolute left-[2rem]  bottom-[-30rem] rgiht-[2rem]'>
                    <h4 className='w-[90%] text-white font-bold text-[2rem]'>
                        Sign up to <span className="text-[#056DFF]">LifeEase</span> website to unlock personalized recommendations, save your <span className="text-[#056DFF]">favorite hostels</span>, book seamlessly, leave reviews. Join today to find your perfect home away from home!
                    </h4>
                </div>
            </div>
